...
class CodeExercise10Controller extends GetxController {
  ...
  final exerciseCaption =
      "Row digunakan untuk menyusun widget - widget di dalamnya secara horizontal. Dengan MainAxis.SpaceAround maka akan menempatkan ruang kosong secara merata di antara widget, serta menempatkan setengah dari ruang kosong tersebut pada sebelum widget pertama dan setelah widget terakhir.";
  ...
  final correctAnswer = BankCodeExercisesHelper.tenthExerciseAnswer.obs;
  final studentAnswer = BankCodeExercisesHelper.tenthExerciseAnswer.obs;
