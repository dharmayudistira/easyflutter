...
class CodeExercise12Controller extends GetxController {
  ...
  final exerciseCaption =
      "Row digunakan untuk menyusun widget - widget di dalamnya secara horizontal. Dengan MainAxis.SpaceEvenly maka akan menempatkan ruang kosong secara merata di antara widget, serta menempatkan ruang kosong tersebut pada sebelum widget pertama dan setelah widget terakhir.";
  ...
  final correctAnswer = BankCodeExercisesHelper.twelfthExerciseAnswer.obs;
  final studentAnswer = BankCodeExercisesHelper.twelfthExerciseAnswer.obs;
