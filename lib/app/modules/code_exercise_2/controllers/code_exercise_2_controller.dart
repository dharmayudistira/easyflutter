...
class CodeExercise2Controller extends GetxController {
  ...
  final exerciseCaption =
      "Column digunakan untuk menyusun widget - widget di dalamnya secara vertikal. Dengan MainAxis.Center maka widget di dalamnya akan tersusun ditengah sumbu utama. Sedangkan CrossAxis.Start akan menyusun widget sedekat mungkin dengan sumbu silang.";
  ...
  final correctAnswer = BankCodeExercisesHelper.secondExerciseAnswer.obs;
  final studentAnswer = BankCodeExercisesHelper.secondExerciseAnswer.obs;
