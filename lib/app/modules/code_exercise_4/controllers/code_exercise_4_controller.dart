...
class CodeExercise4Controller extends GetxController {
  ...
  final exerciseCaption =
      "Row digunakan untuk menyusun widget - widget di dalamnya secara horizontal. Dengan MainAxis.Start maka widget di dalamnya akan tersusun sedekat mungkin dengan sumbu utama. Sedangkan CrossAxis.End akan menyusun widget sedekat mungkin dengan ujung sumbu silang.";
  ...
  final correctAnswer = BankCodeExercisesHelper.fourthExerciseAnswer.obs;
  final studentAnswer = BankCodeExercisesHelper.fourthExerciseAnswer.obs;
