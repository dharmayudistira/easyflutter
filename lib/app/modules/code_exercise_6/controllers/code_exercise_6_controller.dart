...
class CodeExercise6Controller extends GetxController {
  ...
  final exerciseCaption =
      "Row digunakan untuk menyusun widget - widget di dalamnya secara horizontal. Dengan MainAxis.Center maka widget di dalamnya akan tersusun ditengah sumbu utama. Sedangkan CrossAxis.Start akan menyusun widget sedekat mungkin dengan sumbu silang.";
  ...
  final correctAnswer = BankCodeExercisesHelper.sixthExerciseAnswer.obs;
  final studentAnswer = BankCodeExercisesHelper.sixthExerciseAnswer.obs;
