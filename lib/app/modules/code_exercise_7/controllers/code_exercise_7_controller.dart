...
class CodeExercise7Controller extends GetxController {
  ...
  final exerciseCaption =
      "Column digunakan untuk menyusun widget - widget di dalamnya secara vertikal. Dengan MainAxis.SpaceBetween maka akan menempatkan ruang kosong secara merata di antara widget.";
  ...
  final correctAnswer = BankCodeExercisesHelper.seventhExerciseAnswer.obs;
  final studentAnswer = BankCodeExercisesHelper.seventhExerciseAnswer.obs;
