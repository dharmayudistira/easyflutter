...
class WidgetExercise10View extends StatelessWidget {
            ...
            child: Row(
              children: [
                      ...
                      children: [
                        Card(
                          ...
                          child: Center(
                            child: SizedBox(
                              height: 420.h,
                              child: Image.asset(
                                "assets/images/widget/widget_tree10.png",
                              ),
                            ),
                          ),
                        ),
                        Column(
                          children: [
                            ...
                            SizedBox(height: 15.3.r),
                            Row(
                              children: [
                                SizedBox(width: 232.8.h),
                                DragTargetWidget(
                                  acceptAnswer: controller.acceptAnswer,
                                  targetAnswer: controller.targetAnswer,
                                  index: 1,
                ...
                RightContentWidget(
                  ...
                  image: "assets/images/widget/latihan10.png",
                  exerciseName: controller.exerciseName,
                  isStart: controller.isStart,
