...
class WidgetExercise15View extends StatelessWidget {
            ...
            child: Row(
              children: [
                  ...
                  dragTargetContent: Center(
                    child: Stack(
                      children: [
                        Card(
                          ...
                          child: Center(
                            child: SizedBox(
                              height: 420.h,
                              child: Image.asset(
                                "assets/images/widget/widget_tree15.png",
                              ),
                            ),
                          ),
                        ),
                        Column(
                          children: [
                            SizedBox(height: 96.3.r),
                            Row(
                              children: [
                                SizedBox(width: 326.h),
                                DragTargetWidget(
                ...
                RightContentWidget(
                  ...
                  image: "assets/images/widget/latihan15.png",
                  exerciseName: controller.exerciseName,
                  isStart: controller.isStart,
