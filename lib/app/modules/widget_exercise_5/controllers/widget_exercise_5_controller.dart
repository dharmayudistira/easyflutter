...
class WidgetExercise5Controller extends GetxController {
  ...
  final exerciseDescription =
      "Flutter memiliki beberapa widget seperti Icon dan IconButton. Icon merupakan widget untuk menampilkan gambar icon. IconButton merupakan widget untuk menampilkan gambar icon yang dapat ditekan.";
  ...
  List<String> answer = ["Column", "Row", "Icon"];
